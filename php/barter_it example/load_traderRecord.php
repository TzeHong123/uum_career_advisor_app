...
if (isset($_POST['traderid'])){
	...
	$sqlrecord = "SELECT * FROM `tbl_records` WHERE trader_id = '$traderid'";
}
//`record_id`, `record_bill`, `record_paid`, `trader_id`, `owner_id`, `record_date`, `record_status`
...
if ($result->num_rows > 0) {
	...
	while ($row = $result->fetch_assoc()) {
        ...
        $recordlist['owner_phone'] = $row['owner_phone'];
